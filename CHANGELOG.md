...
## 2026-07-13 — إعادة بناء كتالوج النسخ من GitHub

- جعل `BackupJob` في PostgreSQL فهرسًا قابلًا لإعادة البناء من فرعي النسخ الرسميين.
- إضافة مصالحة تلقائية عند إقلاع النظام وفتح مركز النسخ، مع إعادة إنشاء Audit صادق لكل Artifact.
- مطابقة الفهرس مع Retention وحذف فهرسة النسخ المكتملة التي لم تعد موجودة على GitHub.
