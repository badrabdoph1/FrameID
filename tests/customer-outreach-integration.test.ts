...
describe("customer outreach integration", () => {
  it("routes single-customer and bulk customer notifications through the campaign service", async () => {
    ...
    expect(actions.match(/createCustomerOutreachCampaign\(/g)).toHaveLength(2);
