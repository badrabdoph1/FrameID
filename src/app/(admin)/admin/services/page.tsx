import { Activity, BadgeCheck, Boxes, ClipboardList, Plus, Sparkles } from "lucide-react";
...
export default async function AdminServicesPage({ searchParams }: { searchParams: Promise<{ error?: string }> }) {
  ...
  const [products, acquisitionCount, openFulfillment, activeEntitlements] = await Promise.all([
