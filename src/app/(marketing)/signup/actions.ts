...
function getSignupErrorMessage(error: unknown) {
  ...
  if (error instanceof Error) {
    ...
    if (error.message === "هذا الرقم أو البريد الإلكتروني مسجل سابقًا وتم حذف الحساب. لا يمكن إعادة التسجيل بنفس البيانات. للاستفسار، تواصل مع الدعم.") return "هذا الرقم/البريد مسجل سابقًا وتم حذف الحساب. لا يمكن إعادة التسجيل بنفس البيانات. للاستفسار، تواصل مع الدعم.";
