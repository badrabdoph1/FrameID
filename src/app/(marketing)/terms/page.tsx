...
export const metadata: Metadata = {
  ...
  description: "شروط استخدام FrameID للمصورين: الحساب، المحتوى، النشر، الاشتراكات، الحذف، الملكية الفكرية وحدود المسؤولية.",
  alternates: {
    canonical: "/terms"
  },
  openGraph: {
    title: "شروط الاستخدام | FrameID",
    description: "تعرف على الحقوق والالتزامات عند استخدام FrameID لإنشاء موقع مصور وإدارته.",
    url: "/terms",
    type: "website"
  }
};
