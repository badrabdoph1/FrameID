...
export default async function AdminLoginPage({ searchParams }: Props) {
  ...
  return (
    <main className="admin-auth-page flex min-h-screen items-center justify-center bg-[#070707] p-4">
      <div className="w-full max-w-sm">
        <div className="mb-8 text-center">
          ...
          <p className="mt-1 text-sm text-white/50">سجّل الدخول لإدارة المنصة</p>
        </div>
