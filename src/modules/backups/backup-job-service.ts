...
export function createBackupJobService(options: { repository: BackupJobRepository; databaseUrl: string; uploadsDir?: string; backupRoot?: string; backupGitHubToken?: string; backupGitHubRepository?: string; backupEncryptionKey?: string; platformVersion: string; gitCommitSha?: string; now?: () => Date }): BackupJobService {
