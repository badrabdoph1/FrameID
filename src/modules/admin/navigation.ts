...
export const adminRoutes: AdminRouteDefinition[] = [
  ...
  defineRoute({ id: "page-studio", href: "/admin/page-studio", labelAr: "محرر الصفحات", descriptionAr: "إدارة صفحات المنصة ومحتواها", sectionId: "content", visibility: "daily", keywords: ["صفحات", "محرر", "استوديو"], icon: Edit, parentHref: "/admin/content" }),
  defineRoute({ id: "page-studio-editor", href: "/admin/page-studio/[pageId]", labelAr: "تحرير الصفحة", descriptionAr: "تعديل الصفحة المختارة ومعاينتها", sectionId: "content", visibility: "contextual", keywords: ["صفحة", "تحرير", "معاينة"], icon: Edit, parentHref: "/admin/page-studio" }),
  ...
  defineRoute({ id: "messages", href: "/admin/messages", labelAr: "رسائل الاشتراك", descriptionAr: "النصوص التي تظهر للعملاء حسب حالتهم", sectionId: "communication", visibility: "daily", keywords: ["رسائل", "اشتراك", "تفعيل"], icon: MessageSquareText, parentHref: "/admin" }),
  defineRoute({ id: "notifications", href: "/admin/notifications", labelAr: "سجل الإشعارات", descriptionAr: "متابعة ما أرسل للعملاء ونتيجته", sectionId: "communication", visibility: "daily", keywords: ["إشعارات", "إرسال", "سجل"], icon: Bell, parentHref: "/admin" }),
  defineRoute({ id: "support", href: "/admin/support", labelAr: "الدعم", descriptionAr: "طلبات الدعم التي تحتاج متابعة", sectionId: "communication", visibility: "daily", keywords: ["دعم", "طلب", "عميل"], icon: Headphones, parentHref: "/admin" }),
  defineRoute({ id: "email", href: "/admin/email", labelAr: "تسليم البريد", descriptionAr: "تشخيص إرسال البريد ونتائج التسليم", sectionId: "communication", visibility: "daily", keywords: ["بريد", "تسليم", "إرسال"], icon: Mail, parentHref: "/admin" }),
...
const sectionDefinitions: Array<Omit<AdminSection, "links"> & { routeIds: string[] }> = [
  ...
  { id: "content", title: "المحتوى", shortDescription: "الصفحات والقوالب والوسائط", description: "كل أدوات تحرير ونشر المحتوى", accent: "rose", icon: Palette, routeIds: ["content", "page-studio", "templates", "themes", "media", "social-preview"] },
  { id: "communication", title: "التواصل", shortDescription: "الرسائل والدعم", description: "تجربة العميل والإشعارات والدعم والبريد", accent: "violet", icon: MessageSquareText, routeIds: ["messages", "notifications", "support", "email"] },
