...
export const adminRoutes: AdminRouteDefinition[] = [
  ...
  defineRoute({ id: "media", href: "/admin/media", labelAr: "إدارة الوسائط", descriptionAr: "صيانة ومراقبة الصور والملفات المستخدمة في المنصة", sectionId: "content", visibility: "daily", keywords: ["صور", "ملفات", "وسائط", "صيانة", "تنظيف"], icon: Image, parentHref: "/admin/content" }),
