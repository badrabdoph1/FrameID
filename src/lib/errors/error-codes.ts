...
const errorCodes: Record<string, ErrorCodeDef> = {
  ...
  "FID-AUTH-001": {
    ...
    category: "AUTH",
    level: "ERROR",
    message: "فشل تسجيل الدخول. البريد أو كلمة المرور غير صحيحة.",
    suggestion: "تأكد من صحة البريد وكلمة المرور، ثم حاول مرة أخرى.",
    httpStatus: 401,
  },
  "FID-AUTH-002": {
    code: "FID-AUTH-002",
    ...
    suggestion: "استخدم بريداً آخر أو سجل الدخول إذا كان لديك حساب.",
    httpStatus: 409,
  },
  "FID-AUTH-003": {
    code: "FID-AUTH-003",
    ...
    suggestion: "سجل الدخول مرة أخرى للمتابعة.",
    httpStatus: 401,
  },
  "FID-AUTH-004": {
    code: "FID-AUTH-004",
    ...
    suggestion: "تواصل مع المشرف إذا كنت تعتقد أن هذا خطأ.",
    httpStatus: 403,
  },
  "FID-AUTH-005": {
    code: "FID-AUTH-005",
    ...
    suggestion: "تأكد من صحة جميع الحقول وحاول مرة أخرى.",
    httpStatus: 400,
  },
  "FID-AUTH-006": {
    code: "FID-AUTH-006",
    ...
    suggestion: "اطلب رابط استعادة جديد من صفحة نسيت كلمة المرور.",
    httpStatus: 400,
  },
  "FID-AUTH-007": {
    code: "FID-AUTH-007",
    ...
    suggestion: "سجل الدخول بكلمة المرور الجديدة.",
    httpStatus: 200,
  },
  "FID-AUTH-008": {
    code: "FID-AUTH-008",
    category: "AUTH",
    level: "WARN",
    message: "هذا الرابط تم استخدامه من قبل ولا يمكن استخدامه مرة أخرى.",
    suggestion: "اطلب رابط استعادة جديد من صفحة نسيت كلمة المرور.",
    httpStatus: 400,
  },
  "FID-AUTH-009": {
    ...
    category: "AUTH",
    level: "WARN",
    message: "طلبات استعادة كلمة المرور كثيرة جداً. حاول بعد 15 دقيقة.",
  ...
  "FID-AUTH-010": {
    ...
    category: "AUTH",
    level: "ERROR",
    message: "فشل إرسال رابط استعادة كلمة المرور. حاول مرة أخرى.",
  ...
  "FID-AUTH-011": {
    ...
    category: "AUTH",
    level: "WARN",
    message: "كلمة المرور الجديدة ضعيفة. اختر كلمة مرور أقوى.",
    suggestion: "تأكد من أن كلمة المرور تحتوي على حرف كبير وصغير ورقم.",
    httpStatus: 400,
  },
