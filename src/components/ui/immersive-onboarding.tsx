...
function IoCardWelcome({ photographerName }: { photographerName?: string }) {
  ...
  return (
    <div className="flex flex-col items-center py-2 text-center">
      ...
      <p className="io-stagger mt-2 max-w-sm text-sm leading-6 text-white/55 sm:text-base">
...
function IoCardContrast() {
  return (
    <div className="py-1">
      ...
      <p className="io-stagger mt-1.5 text-center text-sm leading-6 text-white/50 sm:text-base">
...
function IoCardReady() {
  return (
    <div className="flex flex-col items-center py-2 text-center">
      ...
      <p className="io-stagger mt-1.5 max-w-sm text-sm leading-6 text-white/50 sm:text-base">
...
function IoCardGuided() {
  ...
  return (
    <div className="py-1 text-center">
      ...
      <p className="io-stagger mt-1.5 text-sm leading-6 text-white/50 sm:text-base">
...
function IoCardStart({ onNext }: { onNext: () => void }) {
  ...
  return (
    <div className="py-1 text-center">
      ...
      <p className="io-stagger mt-1.5 text-sm leading-6 text-white/50">
      ...
      <p className="io-stagger mt-3 text-xs font-black text-white/45 sm:text-sm" style={{ animationDelay: "0.9s" }}>
