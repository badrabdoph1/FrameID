...
export function AdminErrorState({
  title = "حصل خطأ",
  description = "مقدرناش نحمل البيانات. جرب تاني.",
  onRetry,
  className,
  ...
  return (
    <div className={cn("flex flex-col items-center justify-center rounded-xl border border-red-500/10 bg-red-500/5 px-6 py-16 text-center", className)}>
      ...
      {onRetry && (
        <button onClick={onRetry} className="mt-5 inline-flex items-center gap-2 rounded-lg border border-red-500/20 px-4 py-2 text-sm font-extrabold text-red-400 transition hover:bg-red-500/10">
