    ...
    <header className="dashboard-topbar">
      <div>
        <nav className="admin-breadcrumb">
          <Link href="/dashboard">لوحة المصور</Link>
          {crumbs.length > 1 && (
            <>
        ...
        <h1>{getPageTitle() || "لوحة المصور"}</h1>
      </div>
      ...
      <div className="dashboard-topbar-actions">
        ...
        <Link href="/dashboard/content" className="btn-gold" style={{ minHeight: 42 }}>
          <Plus size={18} />
          تعديل المحتوى
        </Link>
